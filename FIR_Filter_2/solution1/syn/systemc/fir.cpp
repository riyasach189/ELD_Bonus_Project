...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( icmp_ln18_reg_195 );
    sensitive << ( mul_ln27_reg_224 );
    ...
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( zext_ln26_1_fu_163_p1 );
    ...
    SC_METHOD(thread_icmp_ln18_fu_152_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_fu_144_p3 );
    sensitive << ( i_0_reg_106 );

    SC_METHOD(thread_mul_ln20_fu_134_p0);
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( input_r );

    SC_METHOD(thread_mul_ln20_fu_134_p2);
    sensitive << ( mul_ln20_fu_134_p0 );

    SC_METHOD(thread_mul_ln27_fu_171_p1);
    sensitive << ( c1_load_reg_219 );
    sensitive << ( ap_CS_fsm_state4 );

    SC_METHOD(thread_mul_ln27_fu_171_p2);
    sensitive << ( shift_reg_load_reg_214 );
    sensitive << ( mul_ln27_fu_171_p1 );
    ...
    sensitive << ( icmp_ln18_fu_152_p2 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_fu_144_p3 );
    sensitive << ( zext_ln26_1_reg_204 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( zext_ln26_fu_158_p1 );
    ...
    SC_METHOD(thread_zext_ln26_1_fu_163_p1);
    sensitive << ( sext_ln16_fu_140_p1 );

    SC_METHOD(thread_zext_ln26_fu_158_p1);
    ...
    sc_trace(mVcdFile, mul_ln20_fu_134_p2, "mul_ln20_fu_134_p2");
    sc_trace(mVcdFile, mul_ln20_reg_187, "mul_ln20_reg_187");
    sc_trace(mVcdFile, icmp_ln18_fu_152_p2, "icmp_ln18_fu_152_p2");
    sc_trace(mVcdFile, icmp_ln18_reg_195, "icmp_ln18_reg_195");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, tmp_fu_144_p3, "tmp_fu_144_p3");
    sc_trace(mVcdFile, zext_ln26_1_fu_163_p1, "zext_ln26_1_fu_163_p1");
    sc_trace(mVcdFile, zext_ln26_1_reg_204, "zext_ln26_1_reg_204");
    ...
    sc_trace(mVcdFile, mul_ln27_fu_171_p2, "mul_ln27_fu_171_p2");
    sc_trace(mVcdFile, mul_ln27_reg_224, "mul_ln27_reg_224");
    ...
    sc_trace(mVcdFile, zext_ln26_fu_158_p1, "zext_ln26_fu_158_p1");
    sc_trace(mVcdFile, grp_fu_127_p0, "grp_fu_127_p0");
    sc_trace(mVcdFile, mul_ln20_fu_134_p0, "mul_ln20_fu_134_p0");
    sc_trace(mVcdFile, sext_ln16_fu_140_p1, "sext_ln16_fu_140_p1");
    sc_trace(mVcdFile, mul_ln27_fu_171_p1, "mul_ln27_fu_171_p1");
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,1,1>(icmp_ln18_reg_195.read(), ap_const_lv1_0))) {
        p_pn_reg_118 = mul_ln27_reg_224.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln18_fu_152_p2.read(), ap_const_lv1_1))) {
        p_pn_reg_118 = mul_ln20_reg_187.read();
    }
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0))) {
        icmp_ln18_reg_195 = icmp_ln18_fu_152_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        mul_ln20_reg_187 = mul_ln20_fu_134_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        mul_ln27_reg_224 = mul_ln27_fu_171_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(icmp_ln18_fu_152_p2.read(), ap_const_lv1_0))) {
        zext_ln26_1_reg_204 = zext_ln26_1_fu_163_p1.read();
    }
}
...
void fir::thread_ap_phi_mux_p_pn_phi_fu_121_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read()) && 
         esl_seteq<1,1,1>(icmp_ln18_reg_195.read(), ap_const_lv1_0))) {
        ap_phi_mux_p_pn_phi_fu_121_p4 = mul_ln27_reg_224.read();
    } else {
...
void fir::thread_c1_address0() {
    c1_address0 =  (sc_lv<3>) (zext_ln26_1_fu_163_p1.read());
}
...
void fir::thread_grp_fu_127_p2() {
    grp_fu_127_p2 = (!grp_fu_127_p0.read().is_01() || !ap_const_lv4_F.is_01())? sc_lv<4>(): (sc_bigint<4>(grp_fu_127_p0.read()) + sc_bigint<4>(ap_const_lv4_F));
}

void fir::thread_icmp_ln18_fu_152_p2() {
    icmp_ln18_fu_152_p2 = (!i_0_reg_106.read().is_01() || !ap_const_lv4_0.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_106.read() == ap_const_lv4_0);
}

void fir::thread_mul_ln20_fu_134_p0() {
    mul_ln20_fu_134_p0 = input_r.read();
}

void fir::thread_mul_ln20_fu_134_p2() {
    mul_ln20_fu_134_p2 = (!mul_ln20_fu_134_p0.read().is_01() || !ap_const_lv32_35.is_01())? sc_lv<32>(): sc_bigint<32>(mul_ln20_fu_134_p0.read()) * sc_biguint<32>(ap_const_lv32_35);
}

void fir::thread_mul_ln27_fu_171_p1() {
    mul_ln27_fu_171_p1 = c1_load_reg_219.read();
}

void fir::thread_mul_ln27_fu_171_p2() {
    mul_ln27_fu_171_p2 = (!shift_reg_load_reg_214.read().is_01() || !mul_ln27_fu_171_p1.read().is_01())? sc_lv<32>(): sc_bigint<32>(shift_reg_load_reg_214.read()) * sc_bigint<10>(mul_ln27_fu_171_p1.read());
}

void fir::thread_output_r() {
    output_r = acc_0_reg_93.read();
}
...
void fir::thread_sext_ln16_fu_140_p1() {
    sext_ln16_fu_140_p1 = esl_sext<32,4>(i_0_reg_106.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<3>) (zext_ln26_1_reg_204.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln18_fu_152_p2.read(), ap_const_lv1_1))) {
        shift_reg_address0 = ap_const_lv3_0;
                ...
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln18_fu_152_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 =  (sc_lv<3>) (zext_ln26_fu_158_p1.read());
    } else {
        shift_reg_address0 =  (sc_lv<3>) ("XXX");
    }
}
...
void fir::thread_tmp_fu_144_p3() {
    tmp_fu_144_p3 = i_0_reg_106.read().range(3, 3);
}

void fir::thread_zext_ln26_1_fu_163_p1() {
    zext_ln26_1_fu_163_p1 = esl_zext<64,32>(sext_ln16_fu_140_p1.read());
}

void fir::thread_zext_ln26_fu_158_p1() {
    zext_ln26_fu_158_p1 = esl_zext<64,4>(grp_fu_127_p2.read());
}
    ...
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(icmp_ln18_fu_152_p2.read(), ap_const_lv1_1))) {
