...
#define AUTOTB_TVOUT_PC_output_r  "../tv/rtldatafile/rtl.fir.autotvout_output_r.dat"
...
int input)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *output_r_pc_buffer = new sc_bv<32>[1];
			int i = 0;
					...
					// bitslice(31, 0)
					{
						...
						// celement: output(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								{
									output_lv0_0_0_1[hls_map_index].range(31, 0) = sc_bv<32>(output_r_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
				...
				// celement: input(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						if (&(input) != NULL) // check the null address if the c port is array or others
						{
							...
							input_tmp_mem = input;
							input_r_tvin_wrapc_buffer.range(31, 0) = input_tmp_mem.range(31, 0);
						}
					}
				}
			}
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* output_r_tvout_wrapc_buffer = new sc_bv<32>[1];
